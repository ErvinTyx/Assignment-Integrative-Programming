    ...
    return (
        <>
            <div key={item.id} className="flex gap-6 p-3">
                <Link href={productRoute(item)} className="w-32 min-h-32 flex justify-center items-center">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex justify-between items-center mt-4">
                            <div className="flex gap-2 items-center">
                                ...
                                <div className={error ? 'tooltip tooltip-error tooltip-open' : ''} data-tooltip={error}>
                                    <TextInput
                                        type="number"
