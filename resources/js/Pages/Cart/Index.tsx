            ...
            <div className="container mx-auto p-8 flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="my-4">
                            {Object.keys(cartItems).length === 0 && (
                                <div className="py-2 text-gray-500 text-center">You don't have any items in your cart</div>
                            )}
                ...
                <div className="card bg-white dark:bg-gray-800 lg:min-w-[260px] order-1 lg:order-2">
                    <div className="card-body">
                        ...
                        <form action={route('cart.checkout')} method="post">
                            <input type="hidden" name="_token" value={csrf_token} />
                            <PrimaryButton className="rounded">Proceed to Checkout</PrimaryButton>
                        </form>
                    </div>
                </div>
