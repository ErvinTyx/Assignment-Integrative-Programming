    ...
    protected function getCartItemsFromDatabase()
{
    ...
    {
        // Get the cart items form the cookie
        $cartItems = $this->getCartItemsFromCookies();
        ...
        // After transfering the cart items to the database, clear the cookie
        Cookie::queue(self::COOKIE_NAME,'', -1);// Delete cookie by setting a negative expiration
    }
}
